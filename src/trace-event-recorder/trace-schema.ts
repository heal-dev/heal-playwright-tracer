...
// Consumers within this package (event-builders, sink adapters,
// active-enter stack) should use the concrete variants so TS narrows
// correctly. Anything that reads a generic event out of the sink
...
import type { SerializedError } from './error-serializer';
 ...
 * stack. The sink stores events by reference, so the mutation is
