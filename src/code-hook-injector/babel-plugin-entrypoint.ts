...
import { buildMatcher, type Include } from './traced-file-matcher';
import { createCjsArtifactDetector } from './statement-analysis/cjs-artifact-detector';
import { createLeafStatementClassifier } from './statement-analysis/leaf-statement-classifier';
import { createNonWrappableStatementPredicate } from './statement-analysis/non-wrappable-statement';
import { createForHeadDeclarationDetector } from './statement-analysis/for-head-declaration-detector';
import { createEnclosingScopeLabeler } from './meta-fields/enclosing-scope-labeler';
import { extractSource } from './meta-fields/source-snippet-extractor';
import { extractLeadingComment } from './meta-fields/leading-comment-extractor';
import { relFile } from './meta-fields/relative-file-path';
import { createPlaywrightImportRewriter } from './playwright-import-rewriter';
import { createGlobalTraceCallBuilder } from './hooks/trace-hook/global-trace-call';
import { createEnterMetaLiteralBuilder } from './hooks/trace-hook/enter-meta-literal';
import { createTryFinallyWrapperBuilder } from './hooks/trace-hook/try-finally-wrapper';
import { createVariableDeclarationHoister } from './hooks/trace-hook/variable-declaration-hoister';
